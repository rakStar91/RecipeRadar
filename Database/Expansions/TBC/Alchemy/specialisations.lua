-------------------------------------------------------
-- Specialisations (Alchemy) - The Burning Crusade Delta
-------------------------------------------------------
if not RR_DATA["specialisations"]["Alchemy"] then RR_DATA["specialisations"]["Alchemy"] = {} end
local tbc_specs = 
{
	{
        ["expansion"] = 2,
...
for _, spec in ipairs(tbc_specs) do
	table.insert(RR_DATA["specialisations"]["Alchemy"], spec)
end
